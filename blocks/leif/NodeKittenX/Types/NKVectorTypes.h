...
union _Q4t
{
    ...
    struct { F1t x, y, z, w; };
    struct { V3t v; float w2;}; // don't need to use w2 cause it's aligned with w


//    _Q4t &operator=( const _Q4t &q ){
//        x=q.x;y=q.y;z=q.z;w=q.w;return *this;
//    }

    _Q4t operator-()const{
        V3t n = -v;
        return _Q4t{n.x,n.y,n.z, w};
    }
    _Q4t operator+( const _Q4t &q )const{
        V3t n = v+q.v;
        return _Q4t{n.x,n.y,n.z,w+q.w};
    }
    _Q4t operator-( const _Q4t &q )const{
        V3t n = v-q.v;
        return _Q4t{ n.x, n.y, n.z, w-q.w};
    ...
    _Q4t operator*( const _Q4t &q )const{
        V3t n = q.v.cross(v)+q.v*w+v*q.w;
        return _Q4t{n.x,n.y,n.z,w*q.w-v.dot(q.v) };
    }
    V3t operator*( const V3t &q )const{
        return (*this * _Q4t{q.x,q.y,q.z,0} * -*this).v;
    }
    _Q4t operator*( float q )const{
        V3t n = v*q;
        return _Q4t {n.x,n.y,n.z, w*q};
    }
    _Q4t operator/( float q )const{
        V3t n = v/q;
        return _Q4t{ n.z,n.y,n.z,w/q };
    }
    float dot( const _Q4t &q )const{
    ...
    _Q4t normalized()const{
        return *this/length();
    }
    _Q4t slerpTo( const _Q4t &q,float a )const{
        _Q4t t=q;
        float d=dot(q),b=1-a;
    ...
    V3t i()const{
        ...
        return V3t{ 1-2*(yy+zz),2*(xy-wz),2*(xz+wy) };
    }
    V3t j()const{
        float yz=v.y*v.z,wx=w*v.x;
        float xy=v.x*v.y,wz=w*v.z;
        float xx=v.x*v.x,zz=v.z*v.z;
        return V3t{ 2*(xy+wz),1-2*(xx+zz),2*(yz-wx) };
    }
    V3t k()const{
        float xz=v.x*v.z,wy=w*v.y;
        float yz=v.y*v.z,wx=w*v.x;
        float xx=v.x*v.x,yy=v.y*v.y;
        return V3t{ 2*(xz-wy),2*(yz+wx),1-2*(xx+yy) };
    }
    
} __attribute__((aligned(16)));

typedef union _Q4t Q4t;
...
static inline V4t  V4MakeF(F1t x)
{
    V4t ret {x,x,x,x};
    return ret;
}
