...
static CocoaGLManager *sharedObject = nil;

@implementation CocoaGLManager
...
//                                          pixelFormat:[[CocoaGLManager sharedInstance] pixelFormat].CGLPixelFormatObj
...
//+(CIContext*)ciContext {
//    return [[CocoaGLManager sharedInstance] ciContext];
//}
//
//-(CIContext*)ciContext {
//    if (!_ciContext) {
...
+ (void)updateWithTimeSinceLast:(F1t)dt {
    [[CocoaGLManager sharedInstance]updateWithTimeSinceLast:dt];
