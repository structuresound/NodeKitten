...
static inline UB4t UB4Color(const std::string& name){
...
union _I2t {
  ...
  I1t operator[]( I1t n )const{
    return (&x)[n];
  }
  _I2t operator-()const{
    return _I2t{ -x,-y };
  }
  _I2t operator*( I1t scale )const{
    return _I2t{ x*scale,y*scale};
  }
  _I2t operator*( const _I2t &q )const{
    return _I2t{ x*q.x,y*q.y};
  }
  _I2t operator/( I1t scale )const{
    return _I2t{ x/scale,y/scale };
  }
  ...
  _I2t &operator*=( I1t scale ){
    x*=scale;y*=scale;return *this;
  }
  _I2t &operator*=( const _I2t &q ){
    x*=q.x;y*=q.y;return *this;
  }
  _I2t &operator/=( I1t scale ){
    x/=scale;y/=scale;return *this;
...
union _V2t {
  ...
  _V2t toCar(){
    return {x*cosf(y),x*sinf(y)};
  }

  _V2t toPol(){
    return {sqrtf(x*x + y*y),atan2f(y,x)};
  }
...
union _V3t {
  ...
  struct { F1t latitude, longitude, radius; };
...
union _V4t
{
  ...
  _V4t(const F1t white, const F1t alpha){
    x = y = z = white; w = alpha;
  }
  _V4t(const F1t f){
    x = y = z = w = f;
  ...
  _V4t(const UB4t color, F1t alpha){
    r = color.r div255;
    g = color.g div255;
    b = color.b div255;
    a = alpha;
  ...
  _V4t(const std::string& name):_V4t(UB4Colors[name]){}
  _V4t(const std::string& name, F1t alpha):_V4t(UB4Colors[name], alpha){}
  ...
  _V4t blend(F1t blendFactor) const{
    return _V4t {
  ...
  _V4t fade(F1t alpha) const{
    return _V4t {r,g,b,a*alpha};
  }

  _V2t rectMidpoint() const{
    return _V2t {origin.x + size.width * 0.5f, origin.y + size.height * 0.5f};
  }
...
union _M16t
{
  ...
  bool operator==(const _M16t& r)const{
    return column1==r.column1 && column2==r.column2 && column3==r.column3 && column4==r.column4;
  }
